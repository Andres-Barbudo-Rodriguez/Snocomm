...
# Script para mostrar información detallada sobre conexiones de red con el comando ss

echo "Bienvenido al script de información de conexiones de red con ss"
