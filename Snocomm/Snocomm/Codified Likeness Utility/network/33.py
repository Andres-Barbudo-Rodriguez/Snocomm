...
class PortForwarder(asyncore.dispatcher):
    def __init__(self, ip, port, remoteip, remoteport, backlog=5):
        asycnore.dispatcher.__init__(self)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Socket de Servidor Stackless')
    ...
    print("redireccionamiento local de puerto %s :%s => remoto %s:%s" % (local_host, local_port, remote_host, remote_port))
